...
$cozyExtraRewards = @{
    ...
    10 = @((Fixed-Reward "cobblemon:poke_bait" 8 $true))
...
$combatExtraRewards = @{
    ...
    28 = @((Fixed-Reward "sophisticatedbackpacks:pickup_upgrade" 1 $true))
    64 = @((Fixed-Reward "sophisticatedbackpacks:filter_upgrade" 1 $true))
    96 = @((Fixed-Reward "sophisticatedbackpacks:deposit_upgrade" 1 $true))
    128 = @((Fixed-Reward "sophisticatedbackpacks:refill_upgrade" 1 $true))
    165 = @((Fixed-Reward "sophisticatedbackpacks:restock_upgrade" 1 $true))
    225 = @((Fixed-Reward "sophisticatedbackpacks:crafting_upgrade" 1 $true))
...
- Combat pass grants only safe upgrades: pickup, filter, deposit, refill, restock, crafting, and jukebox.
