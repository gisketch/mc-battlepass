...
object NpcBossMovesets {
    ...
    private fun defaultTundraArcher(): NpcBossMovesetDefinition = NpcBossMovesetDefinition(
        id = "tundra_archer",
        displayName = "Tundra Archer",
        health = 86.0,
        damage = 3.3,
        attackStartDistance = 14.0,
        offenseChainMin = 2,
        ...
        guardDodgeDistance = 2.7,
        guardDodgeDirection = "side",
        recoveryHitsAllowed = 4,
        parrySpellId = "archers_expansion:frozen_pact",
        parryParticle = "spell_engine:magic_frost_burst",
        parrySoundId = "spell_engine:generic_frost_impact",
        parryDamage = 0.75,
        parryKnockback = 1.15,
        phases = mutableListOf(
            phase(
                id = "frostline_hunt",
                displayName = "Frostline Hunt",
                startsAtHealthRatio = 1.0,
                damageMultiplier = 1.0,
                speedMultiplier = 1.08,
                offenseChainMin = 2,
            ...
            phase(
                ...
                offenseChainRandom = 1,
                offenseChainRecoveryTicks = 6,
                transitionFallback = "Breathe less. The cold has your path.",
                transitionLlmPrompt = "The duel has reached half health and you are entering a faster, stronger Tundra Archer second phase. Reply as Traxex with one short cold battle line about silence, frost, or a clean shot.",
                musicId = "cataclysm:maledictus_music",
                musicVolume = 0.57,
                musicRepeatTicks = 3000,
            ),
        ...
        moves = mutableListOf(
            projectile("frozen_shot", duration = 20, hitTick = 12, damage = 1.45, cooldown = 18, recovery = 14, weight = 8, min = 4.0, max = 14.5, speed = 2.45, inaccuracy = 0.45, spellId = "archers_expansion:frozen_shot", projectileParticle = "minecraft:snowflake", impactParticle = "spell_engine:magic_frost_burst", impactRadius = 0.6, castParticle = "minecraft:snowflake", releaseParticle = "minecraft:snowflake", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:block.glass.hit", statusEffectId = "minecraft:slowness", statusEffectTicks = 45, statusEffectAmplifier = 0, knockback = 0.45),
            projectile("crystal_arrow", duration = 28, hitTick = 18, damage = 2.35, cooldown = 42, recovery = 21, weight = 4, min = 5.0, max = 15.0, speed = 2.6, inaccuracy = 0.2, spellId = "archers_expansion:enchanted_crystal_arrow", projectileParticle = "spell_engine:frost_shard", impactParticle = "spell_engine:magic_frost_burst", impactRadius = 0.85, castParticle = "spell_engine:magic_frost_float", releaseParticle = "minecraft:snowflake", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:block.glass.break", statusEffectId = "minecraft:slowness", statusEffectTicks = 55, statusEffectAmplifier = 1, knockback = 0.8),
            projectile("arctic_volley", duration = 30, hitTick = 19, damage = 1.05, cooldown = 48, recovery = 22, weight = 5, min = 5.0, max = 14.5, speed = 2.35, inaccuracy = 0.8, count = 3, spreadDegrees = 10.0, spellId = "archers_expansion:arctic_volley", projectileParticle = "minecraft:snowflake", impactParticle = "spell_engine:magic_frost_burst", impactRadius = 0.55, castParticle = "minecraft:cloud", releaseParticle = "minecraft:snowflake", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:block.powder_snow.break", statusEffectId = "minecraft:slowness", statusEffectTicks = 35, knockback = 0.35),
            projectile("winters_grip", duration = 32, hitTick = 20, damage = 1.15, cooldown = 76, recovery = 22, weight = 3, min = 4.0, max = 13.5, speed = 2.2, inaccuracy = 0.7, spellId = "archers_expansion:winters_grip", projectileParticle = "minecraft:snowflake", impactParticle = "minecraft:cloud", impactRadius = 0.9, castParticle = "minecraft:cloud", releaseParticle = "spell_engine:magic_frost_burst", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:block.powder_snow.break", statusEffectId = "minecraft:slowness", statusEffectTicks = 55, statusEffectAmplifier = 1, hazardRadius = 3.4, hazardTicks = 70, hazardIntervalTicks = 14, hazardDamage = 0.35, hazardParticle = "minecraft:snowflake", minPhaseIndex = 1),
            projectile("improved_arctic_volley", duration = 36, hitTick = 23, damage = 0.95, cooldown = 84, recovery = 25, weight = 3, min = 5.0, max = 15.0, speed = 2.35, inaccuracy = 0.9, count = 5, spreadDegrees = 16.0, spellId = "archers_expansion:improved_arctic_volley", projectileParticle = "minecraft:snowflake", impactParticle = "spell_engine:magic_frost_burst", impactRadius = 0.6, castParticle = "spell_engine:magic_frost_float", releaseParticle = "minecraft:snowflake", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:block.glass.break", statusEffectId = "minecraft:slowness", statusEffectTicks = 40, minPhaseIndex = 1),
            support("frozen_pact", "spell_engine:one_handed_area_charge", duration = 28, hitTick = 16, cooldown = 96, recovery = 18, weight = 2, min = 0.0, max = 12.0, spellId = "archers_expansion:frozen_pact", absorption = 4.0, absorptionTicks = 90, castParticle = "minecraft:snowflake", supportParticle = "spell_engine:magic_frost_burst", castSoundId = "minecraft:block.powder_snow.step", releaseSoundId = "spell_engine:generic_frost_release", impactSoundId = "spell_engine:generic_frost_impact", releaseAnimationId = "spell_engine:one_handed_area_release"),
            dodge("frost_step", animationId = "spell_engine:dodge", duration = 10, cooldown = 36, distance = 2.8, direction = "side", weight = 2, supportParticle = "minecraft:snowflake", releaseSoundId = "minecraft:block.powder_snow.step", spellId = "archers_expansion:frozen_shot"),
        ),
    )

    private fun defaultWarArcher(): NpcBossMovesetDefinition = NpcBossMovesetDefinition(
        id = "war_archer",
        displayName = "War Archer",
        health = 88.0,
        damage = 3.5,
        attackStartDistance = 13.5,
        offenseChainMin = 2,
        offenseChainRandom = 1,
        offenseChainRecoveryTicks = 7,
        approachAnimationId = "bettercombat:pose_two_handed_bow",
        ...
        guardRollDistance = 2.8,
        guardDodgeAnimationId = "spell_engine:dodge",
        guardDodgeIframeTicks = 9,
        guardDodgeDistance = 2.7,
        guardDodgeDirection = "side",
        recoveryHitsAllowed = 4,
        parrySpellId = "archers_expansion:point_blank_shot",
        parryParticle = "minecraft:crit",
        parrySoundId = "minecraft:entity.arrow.hit_player",
        parryDamage = 0.8,
        parryKnockback = 1.2,
        phases = mutableListOf(
            phase(
                id = "warbow_line",
                displayName = "Warbow Line",
                startsAtHealthRatio = 1.0,
                damageMultiplier = 1.0,
                speedMultiplier = 1.1,
                offenseChainMin = 2,
            ...
            phase(
                ...
                offenseChainRandom = 1,
                offenseChainRecoveryTicks = 6,
                transitionFallback = "The wind has shifted. Loose again.",
                transitionLlmPrompt = "The duel has reached half health and you are entering a faster, stronger War Archer second phase. Reply as Legolas with one short elegant battle line about wind, arrows, battle lines, or clear sight.",
                musicId = "cataclysm:maledictus_music",
                musicVolume = 0.58,
                musicRepeatTicks = 3000,
            ),
        ...
        moves = mutableListOf(
            projectile("dual_shot", duration = 21, hitTick = 13, damage = 1.25, cooldown = 20, recovery = 14, weight = 8, min = 4.0, max = 13.5, speed = 2.5, inaccuracy = 0.45, count = 2, spreadDegrees = 5.0, spellId = "archers_expansion:dual_shot", projectileParticle = "minecraft:crit", impactParticle = "minecraft:enchanted_hit", impactRadius = 0.5, castParticle = "minecraft:crit", releaseParticle = "minecraft:crit", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:entity.arrow.hit", knockback = 0.35),
            projectile("pin_down", duration = 25, hitTick = 16, damage = 1.45, cooldown = 34, recovery = 18, weight = 5, min = 4.0, max = 14.0, speed = 2.45, inaccuracy = 0.4, spellId = "archers_expansion:pin_down", projectileParticle = "minecraft:crit", impactParticle = "minecraft:poof", impactRadius = 0.8, castParticle = "minecraft:enchanted_hit", releaseParticle = "minecraft:crit", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:entity.arrow.hit_player", statusEffectId = "slowness_weakness", statusEffectTicks = 50, knockback = 0.4),
            projectile("smoldering_arrow", duration = 26, hitTick = 17, damage = 1.8, cooldown = 38, recovery = 20, weight = 5, min = 4.5, max = 14.0, speed = 2.4, inaccuracy = 0.45, spellId = "archers_expansion:smoldering_arrow", projectileParticle = "minecraft:flame", impactParticle = "minecraft:lava", impactRadius = 0.85, castParticle = "minecraft:flame", releaseParticle = "minecraft:flame", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:item.firecharge.use", fireTicks = 70, knockback = 0.45),
            projectile("point_blank_shot", duration = 18, hitTick = 9, damage = 1.75, cooldown = 30, recovery = 14, weight = 5, min = 0.0, max = 5.8, speed = 2.75, inaccuracy = 0.55, spellId = "archers_expansion:point_blank_shot", projectileParticle = "minecraft:crit", impactParticle = "minecraft:sweep_attack", impactRadius = 0.75, castParticle = "minecraft:crit", releaseParticle = "minecraft:sweep_attack", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:entity.player.attack.knockback", knockback = 1.35),
            projectile("fan_of_fire", duration = 34, hitTick = 21, damage = 0.95, cooldown = 76, recovery = 24, weight = 4, min = 3.5, max = 13.0, speed = 2.35, inaccuracy = 0.95, count = 5, spreadDegrees = 18.0, spellId = "archers_expansion:fan_of_fire", projectileParticle = "minecraft:flame", impactParticle = "minecraft:lava", impactRadius = 0.55, castParticle = "minecraft:flame", releaseParticle = "minecraft:flame", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:item.firecharge.use", fireTicks = 55, minPhaseIndex = 1),
            projectile("improved_point_blank", duration = 21, hitTick = 11, damage = 2.05, cooldown = 52, recovery = 18, weight = 3, min = 0.0, max = 6.2, speed = 2.85, inaccuracy = 0.35, spellId = "archers_expansion:improved_point_blank_shot", projectileParticle = "minecraft:crit", impactParticle = "minecraft:sweep_attack", impactRadius = 0.95, castParticle = "minecraft:crit", releaseParticle = "minecraft:sweep_attack", releaseSoundId = "minecraft:entity.arrow.shoot", impactSoundId = "minecraft:entity.player.attack.knockback", knockback = 1.75, minPhaseIndex = 1),
            roll("ranger_roll", "combat_roll:roll", duration = 12, cooldown = 42, distance = 3.0, direction = "side", weight = 2, supportParticle = "minecraft:crit", spellId = "archers_expansion:point_blank_shot"),
            dodge("war_step", animationId = "spell_engine:dodge", duration = 10, cooldown = 34, distance = 2.7, direction = "side", weight = 2, supportParticle = "minecraft:crit", releaseSoundId = "minecraft:entity.player.attack.sweep", spellId = "archers_expansion:dual_shot"),
        ),
    )
    ...
    private fun defaultFrostWizard(): NpcBossMovesetDefinition = NpcBossMovesetDefinition(
        id = "frost_wizard",
        ...
        guardDodgeDirection = "side",
        hoverHeight = 0.0,
        parrySpellId = "wizards:frost_shield",
        parryParticle = "spell_engine:magic_frost_burst",
        parrySoundId = "spell_engine:generic_frost_impact",
        parryDamage = 0.75,
        parryKnockback = 1.2,
        phases = mutableListOf(
            ...
            phase(
                ...
                offenseChainRandom = 1,
                offenseChainRecoveryTicks = 5,
                transitionFallback = "The storm is calm now. That makes it stronger.",
                transitionLlmPrompt = "The duel has reached half health and you are entering a faster, stronger Frost Wizard second phase. Reply as Elsa with one short elegant battle line about calm, winter, control, or the storm quieting.",
                musicId = "cataclysm:maledictus_music",
                musicVolume = 0.57,
                musicRepeatTicks = 3000,
            ),
        ...
        moves = mutableListOf(
            magicProjectile("frostbolt", spellId = "wizards:frostbolt", duration = 20, hitTick = 11, damage = 1.55, cooldown = 18, recovery = 12, weight = 8, min = 3.2, max = 12.0, speed = 0.78, impactRadius = 0.6, particle = "spell_engine:magic_frost_float", impactParticle = "spell_engine:magic_frost_burst", animationId = "spell_engine:one_handed_projectile_charge", releaseAnimationId = "spell_engine:one_handed_projectile_release", castParticle = "minecraft:snowflake", releaseParticle = "minecraft:snowflake", castSoundId = "minecraft:block.powder_snow.break", releaseSoundId = "spell_engine:generic_frost_release", impactSoundId = "spell_engine:generic_frost_impact", statusEffectId = "minecraft:slowness", statusEffectTicks = 35, knockback = 0.45),
            magicProjectile("frost_shard", spellId = "wizards:frost_shard", duration = 18, hitTick = 10, damage = 1.45, cooldown = 17, recovery = 11, weight = 7, min = 3.5, max = 12.0, speed = 0.94, impactRadius = 0.5, particle = "minecraft:snowflake", impactParticle = "spell_engine:frost_shard", animationId = "spell_engine:one_handed_projectile_side_charge", releaseAnimationId = "spell_engine:one_handed_projectile_side_release", castParticle = "spell_engine:magic_frost_float", releaseParticle = "minecraft:snowflake", releaseSoundId = "minecraft:block.glass.break", impactSoundId = "minecraft:block.glass.hit", statusEffectId = "minecraft:slowness", statusEffectTicks = 25, knockback = 0.35),
            magicProjectile("ice_lance", spellId = "wizards:frost_shard", duration = 28, hitTick = 17, damage = 2.75, cooldown = 42, recovery = 20, weight = 4, min = 4.0, max = 12.0, speed = 0.64, impactRadius = 1.0, particle = "spell_engine:frost_shard", impactParticle = "spell_engine:magic_frost_burst", animationId = "spell_engine:one_handed_projectile_charge", releaseAnimationId = "spell_engine:one_handed_projectile_release", castParticle = "spell_engine:magic_frost_float", releaseParticle = "minecraft:snowflake", castSoundId = "minecraft:block.powder_snow.step", releaseSoundId = "minecraft:block.glass.break", impactSoundId = "spell_engine:generic_frost_impact", statusEffectId = "minecraft:slowness", statusEffectTicks = 45, statusEffectAmplifier = 1, knockback = 1.05),
            area("frost_nova", "spell_engine:one_handed_area_charge", duration = 26, hitTick = 15, damage = 1.9, radius = 4.3, cooldown = 36, recovery = 16, weight = 6, min = 0.0, max = 4.8, spellId = "wizards:frost_nova", knockback = 1.0, impactParticle = "spell_engine:magic_frost_burst", releaseParticle = "minecraft:snowflake", castParticle = "spell_engine:magic_frost_float", releaseSoundId = "spell_engine:generic_frost_release", impactSoundId = "spell_engine:generic_frost_impact", releaseAnimationId = "spell_engine:one_handed_area_release", statusEffectId = "minecraft:slowness", statusEffectTicks = 50, statusEffectAmplifier = 1),
            area("ice_wall_sweep", "spell_engine:one_handed_area_release_ground_left_to_right", duration = 28, hitTick = 15, damage = 1.65, radius = 5.0, cooldown = 46, recovery = 18, weight = 4, min = 0.0, max = 5.4, spellId = "wizards:frost_nova", knockback = 0.85, arc = 125.0, impactParticle = "minecraft:snowflake", releaseParticle = "spell_engine:magic_frost_burst", castParticle = "spell_engine:magic_frost_float", releaseSoundId = "minecraft:block.glass.place", impactSoundId = "minecraft:block.glass.hit", statusEffectId = "minecraft:slowness", statusEffectTicks = 45, statusEffectAmplifier = 1),
            area("frost_blizzard", "spell_engine:one_handed_sky_charge", duration = 38, hitTick = 22, damage = 1.55, radius = 5.8, cooldown = 82, recovery = 24, weight = 4, min = 0.0, max = 6.3, spellId = "wizards:frost_blizzard", knockback = 0.65, impactParticle = "minecraft:snowflake", releaseParticle = "spell_engine:magic_frost_burst", castParticle = "minecraft:cloud", releaseSoundId = "spell_engine:generic_frost_release", impactSoundId = "spell_engine:generic_frost_impact", statusEffectId = "minecraft:slowness", statusEffectTicks = 60, statusEffectAmplifier = 1, hazardRadius = 4.0, hazardTicks = 80, hazardIntervalTicks = 14, hazardDamage = 0.45, hazardParticle = "minecraft:snowflake", minPhaseIndex = 1),
            magicProjectile("shard_storm", spellId = "wizards:frost_shard", duration = 31, hitTick = 18, damage = 1.15, cooldown = 58, recovery = 20, weight = 4, min = 4.0, max = 12.0, speed = 0.74, impactRadius = 0.55, particle = "minecraft:snowflake", impactParticle = "spell_engine:magic_frost_burst", animationId = "spell_engine:two_handed_channeling", releaseAnimationId = "spell_engine:one_handed_projectile_release", castParticle = "spell_engine:magic_frost_float", releaseParticle = "minecraft:snowflake", castSoundId = "minecraft:block.powder_snow.fall", releaseSoundId = "minecraft:block.glass.break", impactSoundId = "spell_engine:generic_frost_impact", statusEffectId = "minecraft:slowness", statusEffectTicks = 30, knockback = 0.35, count = 3, spreadDegrees = 10.0, minPhaseIndex = 1),
            support("frost_shield", "spell_engine:one_handed_area_charge", duration = 28, hitTick = 16, cooldown = 92, recovery = 18, weight = 2, min = 0.0, max = 9.0, spellId = "wizards:frost_shield", absorption = 4.0, absorptionTicks = 90, castParticle = "spell_engine:magic_frost_float", supportParticle = "spell_engine:magic_frost_burst", castSoundId = "minecraft:block.glass.place", releaseSoundId = "spell_engine:generic_frost_release", impactSoundId = "minecraft:block.glass.hit", releaseAnimationId = "spell_engine:one_handed_area_release"),
            dodge("ice_step", animationId = "spell_engine:dodge", duration = 10, cooldown = 32, distance = 2.8, direction = "side", weight = 3, supportParticle = "minecraft:snowflake", releaseSoundId = "minecraft:block.powder_snow.step", spellId = "wizards:frost_nova"),
        ),
    )
    ...
    private fun defaultPaladin(): NpcBossMovesetDefinition = NpcBossMovesetDefinition(
        id = "paladin",
        displayName = "Paladin",
        health = 120.0,
        damage = 4.0,
        ...
        strafeAnimationId = "",
        strafeAnimationSource = NpcBossAnimationSources.NATURAL,
        guardAnimationId = "bettercombat:pose_one_handed_backwards",
        parryAnimationId = "bettercombat:one_handed_slam",
        recoveryAnimationId = "bettercombat:pose_one_handed_backwards",
        recoveryHitsAllowed = 4,
        guardRollWeight = 2,
        guardDodgeWeight = 0,
        guardParryWeight = 4,
        ...
        guardDodgeDirection = "side",
        parrySpellId = "paladins:barrier",
        parryParticle = "spell_engine:shield_small",
        ...
        phases = mutableListOf(
            ...
            phase(
                ...
                transitionLlmPrompt = "The duel has reached half health and Tarnished enters a faster, harder final-boss Paladin second phase with shield, rolls, holy spells, and heavy mace pressure. Reply as the Tarnished with one short solemn Elden Ring styled battle line about grace, oath, shield, or rising again.",
                musicId = "cataclysm:maledictus_music",
                musicVolume = 0.64,
                musicRepeatTicks = 3000,
            ),
        ...
        moves = mutableListOf(
            melee("guard_counter", "bettercombat:one_handed_slash_horizontal_right", duration = 18, hitTick = 8, damage = 2.35, range = 3.1, arc = 90.0, cooldown = 16, recovery = 18, weight = 7, spellId = "paladins:judgement", releaseParticle = "spell_engine:magic_holy_float", impactParticle = "minecraft:crit", releaseSoundId = "minecraft:entity.player.attack.sweep", impactSoundId = "minecraft:entity.player.attack.strong", knockback = 0.55),
            area("shield_bash", "bettercombat:one_handed_slam", duration = 20, hitTick = 9, damage = 1.75, radius = 2.7, cooldown = 24, recovery = 16, weight = 6, min = 0.0, max = 3.2, spellId = "paladins:barrier", knockback = 1.35, arc = 95.0, impactParticle = "spell_engine:shield_small", releaseParticle = "spell_engine:magic_holy_float", releaseSoundId = "minecraft:item.shield.block", impactSoundId = "minecraft:entity.player.attack.knockback", statusEffectId = "minecraft:weakness", statusEffectTicks = 35),
            melee("mace_heavy", "bettercombat:one_handed_uppercut_right", duration = 28, hitTick = 15, damage = 3.75, range = 3.4, arc = 75.0, cooldown = 36, recovery = 28, weight = 5, spellId = "paladins:judgement", releaseParticle = "spell_engine:magic_holy_float", impactParticle = "spell_engine:magic_holy_burst", releaseSoundId = "minecraft:entity.player.attack.strong", impactSoundId = "paladins:judgement_impact", knockback = 1.05),
            area("golden_slam", "bettercombat:one_handed_slam", duration = 32, hitTick = 18, damage = 2.9, radius = 3.6, cooldown = 48, recovery = 24, weight = 4, min = 0.0, max = 4.2, spellId = "paladins:judgement", knockback = 1.15, impactParticle = "spell_engine:magic_holy_burst", releaseParticle = "spell_engine:area_circle_1", castParticle = "spell_engine:magic_holy_float", releaseSoundId = "minecraft:entity.player.attack.strong", impactSoundId = "paladins:judgement_impact"),
            ...
            roll("medium_roll", "combat_roll:roll", duration = 13, cooldown = 34, distance = 3.1, direction = "side", weight = 3, supportParticle = "spell_engine:magic_holy_decelerate", spellId = "paladins:barrier"),
            roll("back_roll", "combat_roll:roll", duration = 13, cooldown = 42, distance = 3.2, direction = "back", weight = 2, supportParticle = "spell_engine:magic_holy_decelerate", spellId = "paladins:barrier"),
        ),
    )
