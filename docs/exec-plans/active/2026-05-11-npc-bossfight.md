...
- Paladin/Tarnished has a separate final-boss style shield-and-mace boss fight using Elden-style rolls, shield bash/parry, Paladins holy shock/judgement/barrier/banner/beam metadata, absorption-only support, phase-2 Erdtree burst pressure, and no teleport or defensive waiting loop.
