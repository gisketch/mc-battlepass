...
- 2026-05-06: Tuned vendor animation grouping with larger seller paperdoll and top-to-bottom stagger across seller/cart sections; normal shop dialogs now use `9slice_container_yellow` and bounce-scale in.
